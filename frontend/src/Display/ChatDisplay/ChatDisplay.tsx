...
import { type Message, type Thread, fetchMessages, getFullIconUrl } from '../../api/chatApi';
...
export function ChatDisplay({ onBack, thread }: ChatDisplayProps) {
    ...
    <div className={styles.chatContainer}>
      <div className={styles.chatHead}>
        ...
        <div className={styles.personaWrapper}>
          <img src={getFullIconUrl(thread.user_2.avatar)} className={styles.avatar} alt="Avatar" />
