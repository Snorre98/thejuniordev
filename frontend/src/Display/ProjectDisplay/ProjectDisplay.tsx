...
const mockProps = {
  ...
  projectParticipants: ['Sander', 'Benjamin', 'Snorre', 'Sander', 'Benjamin', 'Snorre', 'Benjamin', 'Snorre'],
    ...
    <div className={styles.projectContainer}>
      <div className={styles.projectHeader}>
        <div className={styles.projectIconWrapper}>
          <img src={mockProps.projectIcon} alt="project-icon" className={styles.projectIcon} />
        </div>
