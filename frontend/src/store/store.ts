...
import { type AppSliceState, createAppSlice as createCurrentAppSlice } from './slices/projectSlice';
import { type ThreadSliceState, createThreadSlice } from './slices/threadSlice';

export interface CombinedState extends AppState, ThreadSliceState, AppSliceState {}
